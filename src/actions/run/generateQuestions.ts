  ...
  `,
    ...
    const generatedQuestions = await generateText({
      ...
      prompt: `
        ...
        4. **Immersion**: NEVER use phrases like "based on the Concept Fact", "according to the text", or "which statement is supported". Write the question as if the facts are universal truths.
        5. **Format Precision**: You must strictly obey the specific "Format Instruction" assigned to each task.
        6. **Explanations**: The explanation must be concise (1-2 sentences) and definitively prove why the answer is correct based on the Concept Fact. You may use a slightly thematic, analytical "System/Game Master" tone.
